...
@Slf4j
public class NotificationHandler_storage_driver_list_next extends NotificationHandler_storage_driver_result<StorageListing> {
    ...
    @Override protected StorageListing handle(ReceivedNotification n, StorageDriverNotification notification, CloudService storage) throws IOException {
        return storage.getStorageDriver(configuration).listNext(n.getFromNode(), notification.getKey());
    }
